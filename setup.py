#!/usr/bin/env python
# This file is part account_bank_statement_paypal module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton Account Bank Statement ES CSB43 Module',
    ...
    convert_2to3_doctests=[
        'tests/scenario_account_bank_statement_paypal.rst',
        ],
    )
